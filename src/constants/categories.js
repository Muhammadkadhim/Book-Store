export const categories = [
    {
        ...
        url: "/arts",
        subCategory: [
            { txt: "Architecture", url: "/arts/architecture" },
            { txt: "Art Instruction", url: "/arts/art_instrction" },
            { txt: "Art History", url: "/arts/art_history" },
            { txt: "Dance", url: "/arts/dance" },
            { txt: "Design", url: "/arts/design" },
            { txt: "Fasion", url: "/arts/fasion" },
            { txt: "Film", url: "/arts/film" },
            { txt: "Music", url: "/arts/music" },
        ],
    },
    {
        title: "Children",
