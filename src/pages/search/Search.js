...
import { saveSearchedRes } from "../../redux/searchSlice";
        ...
        axios
            ...
            .then((data) => {
                ...
                if (!(works.length > 0)) {
                    ...
                    dispatch(saveSearchedRes(works));
                    setLoading(false);
                    setNoBooksFound(false);
                }
            });
        ...
        <div className="flex flex-col gap-20 py-10  items-center ">
            <div className="flex flex-col-reverse md:flex-row items-center justify-center w-10/12 mx-auto mt-20">
                ...
                >
                    ...
                    <button
                        className={` p-2.5 ml-2 text-sm font-medium text-white bg-base-300 h-full hover:bg-black transition ease-out duration-150 rounded-lg focus:outline-none`}
                    >
